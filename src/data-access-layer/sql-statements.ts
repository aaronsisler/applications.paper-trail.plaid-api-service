...
export const SQL_STG_ADDED_ACCOUNT_TRANSACTION_CREATE = `INSERT INTO ${DATABASE_TABLE.STG_ADDED_ACCOUNT_TRANSACTION} 
(
  user_id,
  transaction_id,
  account_id,
...
export const SQL_STG_MODIFIED_ACCOUNT_TRANSACTION_CREATE_SPROC = `CALL sp_Create_StagedAddedAccountTransactions (?)`;

export const SQL_STG_REMOVED_ACCOUNT_TRANSACTION_CREATE = `INSERT INTO ${DATABASE_TABLE.STG_REMOVED_ACCOUNT_TRANSACTION} 
